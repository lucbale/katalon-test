...
def static runTestCase_0() {
    TestCaseMain.runTestCase('Test Cases/DDT-login', new TestCaseBinding('Test Cases/DDT-login',  null), FailureHandling.STOP_ON_FAILURE)
...
RunConfiguration.setExecutionSettingFile("C:\\Users\\Win8.1\\Katalon Studio\\MarketPlaceManager\\Reports\\login-excel\\20180118_151213\\execution.properties")
